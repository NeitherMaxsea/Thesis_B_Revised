<section id="jobs" class="scroll-reveal scroll-mt-24 bg-white py-12 sm:py-14" data-scroll-reveal>
    ...
    <div class="job-search-band mt-7 px-5 py-8">
        <div class="mx-auto max-w-[980px]">
            <div class="grid gap-2 rounded-lg sm:grid-cols-[1fr_auto_auto_auto]">
                <label class="job-search-field">
                    ...
                    <input type="search" placeholder="Search job Title, Keyword or Company" class="h-full w-full bg-transparent text-xs font-medium text-slate-900 outline-none placeholder:text-slate-500">
                </label>

                <button type="button" class="job-filter-button">
                    ...
                    Category
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.1" aria-hidden="true">
                ...
                <button type="button" class="job-search-button">Search Jobs</button>
            </div>

            <div class="mt-5 flex flex-wrap justify-center gap-3">
                <button type="button" class="job-pill is-active">All Jobs</button>
                <button type="button" class="job-pill">Full time</button>
                <button type="button" class="job-pill">Part Time</button>
            </div>
        </div>
    </div>

    <div class="mx-auto mt-8 max-w-[980px] px-5">
        <div class="job-empty-state">
            ...
            <p>Job listings will appear here once you add your first post.</p>
        </div>
    </div>
</section>
